...
/*********************************
*	Triangle Class	Headers		 *
**********************************/
class Triangle : public Texture { 
	friend class Raster;

    public:
		Triangle(ColorInfo *colors, Vector3d point1, Vector3d point2, Vector3d point3, bool polyPatch = false, Vector3d normal1 = Vector3d(0, 0, 0), Vector3d normal2 = Vector3d(0, 0, 0), Vector3d normal3 = Vector3d(0, 0, 0));
